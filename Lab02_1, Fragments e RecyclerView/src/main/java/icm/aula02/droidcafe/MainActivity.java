...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<Food> available_foods = new ArrayList<Food>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Food donut = new Food("Donut",1.5,"Donuts are glazed and sprinkled with candy.", R.drawable.donut_circle,0);
        Food froyo = new Food("Froyo",2.4,"FroYo is premium self-serve frozen yogurt.",R.drawable.froyo_circle,0);
        Food iceCream = new Food("IceCream",1.8,"Ice cream sandwiches have chocolate wafers and vanilla filling.",R.drawable.icecream_circle,0);

        available_foods.add(iceCream);
        available_foods.add(froyo);
        available_foods.add(donut);
    ...
    public void showDonutOrder(View view){
        ...
        if (inList==false){
            for (Food elem: available_foods)
                if (elem.getName().equals("Donut")){
                    shopping_list.add(elem);
                    elem.incAmount();
            }
        };
    }
